...
# ************************************
# Write a method that takes an array of numbers as input and returns
# the sum of each element multiplied by its index.
...
# returns the longest word.  If there is more
# than one word of that length, it should return the first instance of
# that word.
...
# the string.  For our purposes, "y" counts as a vowel.
# You might want to use the Array#include? method for this.
# The usage is:
...
# ************************************
# Write a method that takes a string of words separated by spaces and
# returns a string the same as the original, but
...
# For our purposes, count "y" as a vowel.
