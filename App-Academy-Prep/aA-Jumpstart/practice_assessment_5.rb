...
def save_the_prisoner(prisoners, sweets, id)
  current_prisoner = (id + sweets - 1) % prisoners
  current_prisoner == 0 ? prisoners : current_prisoner
end
