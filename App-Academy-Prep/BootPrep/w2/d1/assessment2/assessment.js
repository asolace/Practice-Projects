...
function royalWe(sentence){
  ...
  // return words.join(" ");
  // Solution 2
  var replaced = sentence.replace(/I/g, "we");
  replaced = replaced.replace(/mine/g, "ours");
  replaced = replaced.replace(/my/g, "our");
  replaced = replaced.replace(/me/g, "us");
  return replaced;
};
