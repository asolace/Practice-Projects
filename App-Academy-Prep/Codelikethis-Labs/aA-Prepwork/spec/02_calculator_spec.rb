...
describe "#multiply" do
  ...
  it "multiply two negatie numbers" do
    expect(multiply(-3, -3)).to eq(9)
  end

  it "multiply one negative and one positive numbers" do
    expect(multiply(-2, 2)).to eq(-4)
  end
end

describe "#multipies" do
  it "multiplies several numbers" do
    expect(multipies([1, 2, 3])).to eq(6)
  end

  it "multiplies several negative numbers" do
    expect(multipies([-1, -2, -3, -4])).to eq(24)
  end
end
