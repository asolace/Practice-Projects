...
class Game < Gosu::Window
	...
	def initialize
		...
		super(width, width, false) # false; not fullscreen
	...
	def button_down(id)
		case id
		when Gosu::KbQ
			close # When you press Q it will close the window
		when Gosu::MsLeft
	...
	def draw
		...
		# displays message
		display_message("You're the Winner!") if @position.win?("x")
		display_message("You're the Winner!") if @position.win?("x")
		display_message("It's a Draw!") if @position.possible_moves.empty?
	end
